...
esbuild
  .build({
    ...
    format: "esm",
    target: ["esnext"],
    external: ["antd", "react", "dayjs", "rc-picker"],
  })
...
copyFileSync(
  join(__dirname, "antd-jalali.d.ts"),
  join(outTypes, "antd-jalali.d.ts"),
);
copyFileSync(
  join(__dirname, "dayjs-jalali.d.ts"),
  join(outTypes, "dayjs-jalali.d.ts"),
);

writeFileSync(join(lib, "index.js"), "export * from './esm/index.js';");

writeFileSync(
  join(lib, "index.cjs.js"),
